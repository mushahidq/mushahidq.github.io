    ...
    <Router>
      ...
      <footer className="footer">
        <div className="social-icons">
          ...
          <a
            className="social-icons"
            href="mushahidq.github.io"
            aria-label="portfolio"
            target="_blank"
            rel="noopener noreferrer"
          >
            <img src="https://vbr.nathanchung.dev/badge?page_id=mushahidq.github.io&color=55acb7&style=for-the-badge&logo=Github&text=Visitors" />
          </a>
        </div>
        <div className="copyright">©2026 Mohammed Mushahid Qureshi</div>
      </footer>
    </Router>
  );
}
